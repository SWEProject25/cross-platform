...
//       final data = res['data'];
//       if (data is Map && data.containsKey('profileImageUrl')) {
//         return Future.value(data['profileImageUrl']);
//       }
//       if (data is Map && data.containsKey('bannerImageUrl')) {
//         return Future.value(data['bannerImageUrl']);
//       }
//       if (data is Map && data.containsKey('url')) {
//         return Future.value(data['url']);
//       }
//     }
...
//       endpoint: "/profile/me/profile-picture",
//       data: form,
//     );
