...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( String identifier,  String passwordLogin,  int currentLoginStep)?  login,TResult Function( String name,  bool isValidName,  String email,  bool isValidEmail,  String passwordSignup,  bool isValidSignupPassword,  String code,  bool isValidCode,  String username,  bool isValidUsername,  String date,  bool isValidDate,  String imgPath,  int currentSignupStep)?  signup,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LoginState() when login != null:
return login(_that.identifier,_that.passwordLogin,_that.currentLoginStep);case _SignupState() when signup != null:
return signup(_that.name,_that.isValidName,_that.email,_that.isValidEmail,_that.passwordSignup,_that.isValidSignupPassword,_that.code,_that.isValidCode,_that.username,_that.isValidUsername,_that.date,_that.isValidDate,_that.imgPath,_that.currentSignupStep);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( String identifier,  String passwordLogin,  int currentLoginStep)  login,required TResult Function( String name,  bool isValidName,  String email,  bool isValidEmail,  String passwordSignup,  bool isValidSignupPassword,  String code,  bool isValidCode,  String username,  bool isValidUsername,  String date,  bool isValidDate,  String imgPath,  int currentSignupStep)  signup,}) {final _that = this;
switch (_that) {
case _LoginState():
return login(_that.identifier,_that.passwordLogin,_that.currentLoginStep);case _SignupState():
return signup(_that.name,_that.isValidName,_that.email,_that.isValidEmail,_that.passwordSignup,_that.isValidSignupPassword,_that.code,_that.isValidCode,_that.username,_that.isValidUsername,_that.date,_that.isValidDate,_that.imgPath,_that.currentSignupStep);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( String identifier,  String passwordLogin,  int currentLoginStep)?  login,TResult? Function( String name,  bool isValidName,  String email,  bool isValidEmail,  String passwordSignup,  bool isValidSignupPassword,  String code,  bool isValidCode,  String username,  bool isValidUsername,  String date,  bool isValidDate,  String imgPath,  int currentSignupStep)?  signup,}) {final _that = this;
switch (_that) {
case _LoginState() when login != null:
return login(_that.identifier,_that.passwordLogin,_that.currentLoginStep);case _SignupState() when signup != null:
return signup(_that.name,_that.isValidName,_that.email,_that.isValidEmail,_that.passwordSignup,_that.isValidSignupPassword,_that.code,_that.isValidCode,_that.username,_that.isValidUsername,_that.date,_that.isValidDate,_that.imgPath,_that.currentSignupStep);case _:
...
class _LoginState extends AuthenticationState {
  const _LoginState({this.identifier = "", this.passwordLogin = "", this.currentLoginStep = 0}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _LoginState&&(identical(other.identifier, identifier) || other.identifier == identifier)&&(identical(other.passwordLogin, passwordLogin) || other.passwordLogin == passwordLogin)&&(identical(other.currentLoginStep, currentLoginStep) || other.currentLoginStep == currentLoginStep));
}


@override
int get hashCode => Object.hash(runtimeType,identifier,passwordLogin,currentLoginStep);

@override
String toString() {
  return 'AuthenticationState.login(identifier: $identifier, passwordLogin: $passwordLogin, currentLoginStep: $currentLoginStep)';
}
...
@useResult
$Res call({
 String identifier, String passwordLogin, int currentLoginStep
});
...
/// Create a copy of AuthenticationState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? identifier = null,Object? passwordLogin = null,Object? currentLoginStep = null,}) {
...
class _SignupState extends AuthenticationState {
  const _SignupState({this.name = "", this.isValidName = false, this.email = "", this.isValidEmail = false, this.passwordSignup = "", this.isValidSignupPassword = false, this.code = "", this.isValidCode = false, this.username = "", this.isValidUsername = false, this.date = "", this.isValidDate = false, this.imgPath = "", this.currentSignupStep = 0}): super._();
...
@useResult
$Res call({
 String name, bool isValidName, String email, bool isValidEmail, String passwordSignup, bool isValidSignupPassword, String code, bool isValidCode, String username, bool isValidUsername, String date, bool isValidDate, String imgPath, int currentSignupStep
});
