  ...
  void initState() {
   ...
   _controllerRepost=AnimationController(
    ...
    _scaleAnimation = Tween<double>(
     ...
     _scaleAnimationRepost = Tween<double>(
      begin: 1.0,
      end: 1.3,
    ).animate(CurvedAnimation(parent: _controllerRepost, curve: Curves.easeOut));
  }
              ...
              children: [
                ...
                Padding(
                  ...
                  child: ScaleTransition(
                    ...
                    child: GestureDetector(
                      onTap: _handlerepost,
                      child: isReposted ? Icon(Icons.loop, color: Colors.green,):Icon(Icons.loop, color: Colors.grey),
                    ),
                  ),
                ),
                Padding(
