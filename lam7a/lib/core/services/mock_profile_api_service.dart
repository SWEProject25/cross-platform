import 'dart:async';
import '../../features/profile_header/model/profile_header_model.dart';
...
class MockProfileAPIService {
  ...
  Future<ProfileHeaderModel> fetchProfile(String username) async {
    ...
    // Generate different mock profiles depending on username
    switch (username.toLowerCase()) {
      case 'hossam_dev':
        return ProfileHeaderModel(
          ...
          joinedDate: 'May 2021',
          mutualFollowers: ['Ali', 'Mona', 'Sarah', 'Youssef'],
          isVerified: true,
        );
