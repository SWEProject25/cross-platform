...
class AuthApi {
  ...
  ///
  /// Parameters:
  /// * [checkEmailDto] - Email to be checked
  ...
  Future<Response<ApiResponseDto>> authControllerCheckEmail({ 
    required CheckEmailDto checkEmailDto,
    ...
    final _path = r'/api/v1.0/auth/check-email';
    ...
    try {
      const _type = FullType(CheckEmailDto);
      _bodyData = _serializers.serialize(checkEmailDto, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [ApiResponseDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiResponseDto>> authControllerGenerateVerificationEmail({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1.0/auth/verification-otp';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [ApiResponseDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiResponseDto>> authControllerGetMe({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1.0/auth/me';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> authControllerGoogleLogin({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1.0/auth/google/login';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> authControllerGoogleRedirect({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1.0/auth/google/redirect';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Login with the provided details (JWT set as HTTPOnly cookie)
  ///
  /// Parameters:
  ...
  Future<Response<LoginResponseDto>> authControllerLogin({ 
    ...
    final _path = r'/api/v1.0/auth/login';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [ApiResponseDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiResponseDto>> authControllerLogout({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1.0/auth/logout';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<RegisterResponseDto>> authControllerRegister({ 
    ...
    final _path = r'/api/v1.0/auth/register';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [ApiResponseDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiResponseDto>> authControllerResendVerificationEmail({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1.0/auth/resend-otp';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Test endpoint
  /// A protected test endpoint to verify JWT authentication.
  ///
  /// Parameters:
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  ...
  /// Returns a [Future] containing a [Response] with a [ApiResponseDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiResponseDto>> authControllerTest({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1.0/auth/test';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [ApiResponseDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiResponseDto>> authControllerUpdateEmail({ 
    ...
    final _path = r'/api/v1.0/auth/update-email';
    final _options = Options(
      method: r'PATCH',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(UpdateEmailDto);
      _bodyData = _serializers.serialize(updateEmailDto, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [ApiResponseDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiResponseDto>> authControllerUpdateUsername({ 
    required UpdateUsernameDto updateUsernameDto,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1.0/auth/update-username';
    final _options = Options(
      method: r'PATCH',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(UpdateUsernameDto);
      _bodyData = _serializers.serialize(updateUsernameDto, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [ApiResponseDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiResponseDto>> authControllerVerifyEmailOtp({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1.0/auth/verify-otp';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> authControllerVerifyRecaptcha({ 
    required RecaptchaDto recaptchaDto,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1.0/auth/verify-recaptcha';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(RecaptchaDto);
      _bodyData = _serializers.serialize(recaptchaDto, specifiedType: _type);
